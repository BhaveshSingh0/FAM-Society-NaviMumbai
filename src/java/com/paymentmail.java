...
public class paymentmail {
    ...
    //test commit
    public int send( String emailAddress , int amount , String  month){
	...
	String host = "smtp.gmail.com";
        ...
        String subject = "FAM Housing Society  ";
        String message = "Thanks For Giving Maintenance for "+month+" Amount : "+ amount;
        try {
